...
class _$ICUCurrent extends ICUCurrent {
  ...
  _$ICUCurrent._(
      ...
      this.subValues})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(year, 'ICUCurrent', 'year');
    BuiltValueNullFieldError.checkNotNull(month, 'ICUCurrent', 'month');
    BuiltValueNullFieldError.checkNotNull(day, 'ICUCurrent', 'day');
  }
      ...
      _$result = _$v ??
          new _$ICUCurrent._(
              ...
              year: BuiltValueNullFieldError.checkNotNull(
                  year, 'ICUCurrent', 'year'),
              month: BuiltValueNullFieldError.checkNotNull(
                  month, 'ICUCurrent', 'month'),
