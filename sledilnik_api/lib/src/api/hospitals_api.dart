...
class HospitalsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<HospitalsDay>] as data
  ...
  Future<Response<BuiltList<HospitalsDay>>> hospitalsGet({
    ...
    BuiltList<HospitalsDay> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(HospitalsDay)]);
