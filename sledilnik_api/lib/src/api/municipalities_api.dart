...
class MunicipalitiesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<MunicipalityDay>] as data
  ...
  Future<Response<BuiltList<MunicipalityDay>>> municipalitiesGet({
    ...
    final _path = r'/api/municipalities';
    ...
    BuiltList<MunicipalityDay> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(MunicipalityDay)]);
