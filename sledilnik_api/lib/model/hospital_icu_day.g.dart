...
Serializer<HospitalICUDay> _$hospitalICUDaySerializer =
    new _$HospitalICUDaySerializer();
...
class _$HospitalICUDaySerializer
  ...
  @override
  final String wireName = 'HospitalICUDay';
  ...
  HospitalICUDay deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new HospitalICUDayBuilder();
...
class HospitalICUDayBuilder
  ...
  HospitalICUDayBuilder() {
    HospitalICUDay._initializeBuilder(this);
  }
